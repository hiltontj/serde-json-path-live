...
export const SerdeJsonPathProvider = ({
  children,
}: SerdeJsonPathProviderProps) => {
...
export const useSerdeJsonPathState = (): States.State => {
  ...
  if (state === null || state === undefined) {
    throw new Error(
      "useSerdeJsonPathState must be used within a SerdeJsonPathProvider"
    );
  }
  return state;
};
...
export const useSerdeJsonPathDispatch = (): Dispatcher => {
  ...
  if (dispatch === null || dispatch === undefined) {
    throw new Error(
      "useSerdeJsonPathDispatch must be used within a SerdeJsonPathProvider"
    );
  }
  return dispatch;
};
